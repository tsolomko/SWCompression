...
struct Constants {
    ...
    static let secondTestAnswerPath = testBundle.url(forResource: "secondtest", withExtension: "txt")!

    static let emptyFileArchivePath = testBundle.url(forResource: "empty.txt", withExtension: "gz")!

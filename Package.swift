...
var package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/tsolomko/BitByteData", .upToNextMinor(from: "2.1.0")),
    ],
    targets: [
        .target(
            name: "SWCompression",
        ...
        .testTarget(
            ...
            resources: [
                ...
                .copy("Test Files/Deflate/test6.deflate"),
                .copy("Test Files/Deflate/test9.deflate"),
                .copy("Test Files/Deflate/test8.deflate"),
                ...
                .copy("Test Files/7z/test_lzma_big_dict.7z"),
